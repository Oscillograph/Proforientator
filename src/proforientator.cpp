#include <include/proforientator.h>
...
namespace Savannah 
{
	...
	{
		m_NewSkillsGroupIcon = new OpenGLTexture2D("./data/img/icon_add.png");
	}
...
Ползунком отмечается уровень мастерства с оценкой от 0 до 10.)";
